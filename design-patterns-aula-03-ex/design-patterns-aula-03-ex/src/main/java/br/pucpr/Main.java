...
public class Main {
  public static void main(String[] args) {
    ...
    System.out.println("-------------------");
    new Table().print(new UserTableData(usuarios, true), true, LIGHT);
    ...
    System.out.println("-------------------");
    new Table().print(new PlanetasTableData(planetas), false, Theme.NORMAL);
  }
}
